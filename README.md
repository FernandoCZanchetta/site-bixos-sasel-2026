...
This site was developed as a tool to the reception of the electrical engineering freshmen from 2026, at EESC-USP. It's objective is to display all relevant info regarding the university.

## Executing

1.  `git clone git@github.com:sa-sel/site-bixos-2026.git`
2.  `cd /path/to/site-bixos-2026/`
3.  `npm install`
4.  `ng serve`
...
2.  Choose a task you want to work [in the board](https://github.com/orgs/sa-sel/projects/11)
